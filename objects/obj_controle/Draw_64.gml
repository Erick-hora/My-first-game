...
draw_text_color(_largura/2, _altura/2, "Neste jogo voce deve desviar e destruir os asteroides para ganhar pontos, para ganhar voce deve adquirir 1000 ou mais pontos", c_white, c_white, c_white, c_white, 1);
draw_text_ext_color()
}else if room == jogo {
